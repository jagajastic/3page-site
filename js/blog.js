...
// render the db content in browser
// grab the div to render content
const contentContainer = document.querySelector("#contentContainer");
// loop over the db of post and populate the blog page
db.map((post, index) => {
  const postContent = `
    <div class="pt-2" id="postList" onclick="singlePost(${index})">
